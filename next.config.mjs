...
const nextConfig = {
  ...
  async redirects() {
    return [
      // Redirect old view routes to new app routes if needed
      {
        source: "/view/:path*",
        destination: "/:path*",
        permanent: true,
